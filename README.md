...
A full-stack web application clone of Airbnb built with Node.js, Express, MongoDB, and EJS templating engine. This project enables users to browse, create, edit, and review property listings, featuring user authentication and image upload capabilities.
...
- **Category Filtering**: Browse properties by categories (Mountains, Trending, Iconic City, Castle, Amazing pools, Camping, Farms, Arctic)
...
For support, email-simanraj9838@gamil.com or open an issue in the repository.
